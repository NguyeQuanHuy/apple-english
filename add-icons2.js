    ...
    health: (
      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-400 to-pink-600 flex items-center justify-center shadow-md">
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          ...
          <path d="M10 11 L14 11 L14 15 M14 11 L18 11" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      </div>
    ),
    shopping: (
...
c = c.slice(0, idx + insertAfter.length) + newIcons + c.slice(idx + insertAfter.length);
fs.writeFileSync('app/learn/toeic/page.tsx', c, 'utf8');
console.log('technology:', fs.readFileSync('app/learn/toeic/page.tsx','utf8').includes('technology'));
