      ...
      <div className="bg-white border-b border-zinc-200 px-4 py-4">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">Dán văn bản tiếng Anh — AI phân tích IPA từng từ</p>
          </div>
        </div>
      </div>
        ...
        {result && result.words && result.words.length>0 && (
          <>
            <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-5">
              ...
              {result.explanation && <p className="text-sm text-indigo-600 mt-2 leading-relaxed">{result.explanation}</p>}
            </div>
            <div className="bg-white rounded-2xl border border-zinc-200 p-5 shadow-sm">
