...
// Tim ket thuc cua TOEIC_THEMES array chinh xac
const themesStart = c.indexOf('TOEIC_THEMES: ToeicTheme[]');
const testsStart = c.indexOf('export const TOEIC_TESTS');
const themesSection = c.slice(themesStart, testsStart);
const lastBracketInThemes = themesStart + themesSection.lastIndexOf('];');

console.log('Insert at:', lastBracketInThemes);
console.log('Context:', c.slice(lastBracketInThemes-30, lastBracketInThemes+5));
...
const newThemes = ,
  ...
  },
  {
    ...
    words: [
      ...
      { en: "checkup", pos: "n.", vi: "kh\u00e1m \u0111\u1ecbnh k\u1ef3", example: "The company offers an annual checkup for all staff." },
...
const result = c.slice(0, lastBracketInThemes) + newThemes + '\n' + c.slice(lastBracketInThemes);
